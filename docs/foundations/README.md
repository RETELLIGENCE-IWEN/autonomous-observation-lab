...
1. **POMDPs and belief states** — the formal language for hidden state, accumulated evidence, uncertainty, and action under partial observability.
...
The next recommended note is **POMDPs and Belief States**. RSSM provides a learned mechanism for maintaining predictive latent state; POMDP theory provides the normative problem statement that explains what such a state is trying to summarize and how it should support action.
