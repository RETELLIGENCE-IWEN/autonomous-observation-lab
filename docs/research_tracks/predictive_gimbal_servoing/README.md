...
- [On-Policy Sequence-Oracle Aggregation V12](on_policy_distillation_v12_experiment.md)
- [State-Consistent Failure-Gated Correction V13](failure_gated_v13_experiment.md)
- [Deployable-Reference Sequence Oracle V14](deployable_sequence_oracle_v14_experiment.md)
